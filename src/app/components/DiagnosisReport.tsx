      ...
      <div className="px-6 pt-2 pb-8">
        ...
        <div className="rounded-[28px] border border-[#DCE7DF] bg-white p-6">
          ...
          <div className="mt-6 space-y-3">
            <button
              onClick={() => navigate('/booking')}
              className="w-full rounded-2xl bg-[#1E9E6F] px-5 py-3 text-sm font-bold text-white"
            >
              Book follow-up care
            </button>
            <button
              onClick={() => navigate('/vaccination-management')}
              className="w-full rounded-2xl bg-[#E6F7EF] px-5 py-3 text-sm font-bold text-[#1E9E6F]"
            >
