...
import { Star, MapPin, Share2, AlertCircle } from 'lucide-react';
      ...
      <div className="flex flex-col pb-20">
        ...
        <div className="px-6">
          <div className="grid grid-cols-3 gap-4">
            ...
            <button className="relative rounded-[24px] bg-[#F3EBFF] p-6 text-center transition-transform hover:scale-105">
              <div className="flex justify-center">
